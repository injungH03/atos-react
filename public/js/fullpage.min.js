...
!function(n, t) {
    ...
    function fo(n) {
        ...
        function() {
            if (Ci.qn && (a || l)) {
                ...
                n.removeEventListener(Ci.qn, Ii, {
                    passive: !1
                }),
                n.addEventListener(Ci.Gn, Bi),
                n.addEventListener(Ci.qn, Ii, {
                    passive: !1
                })
            }
        }()) : (ao(!1),
    ...
    function Vo() {
        ...
        v("error", "https://github.com/alvarotrigo/fullPage.js#options")) : Tt() && dn.Zn || r.domain.indexOf("alvarotrigo.com") > -1 ? n && n.length : (v("error", "Incorrect `licenseKey`. Get one for fullPage.js version 4 here:"),
